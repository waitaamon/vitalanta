        ...
        <div class="row">
            <div class="col-md-10">
                <div class="panel panel-default">
                    <div class="panel-heading text-center">Your Videos</div>
                                    ...
                                    <div class="row">
                                        <div class="col-sm-3">
                                            <a href="/videos/{{ $video->uid }}">
                                                <img src="{{ $video->getThumbnail() }}" class="img-responsive" alt=" {{ $video->title }} thumnail">
                                            </a>
                                        </div>
                                        <div class="col-sm-9">
                                            ...
                                            <div class="row">
                                                <div class="col-sm-6">
                                                    ...
                                                    <form action="/videos/{{ $video->uid }} " method="post">
                                                        <a href="/videos/{{ $video->uid }}/edit" class="btn btn-default">Edit video</a>
